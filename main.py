...
def main():
    ...
    if "voice_pipeline" not in st.session_state:
        try:
            ...
            st.error(f"⚠️ Voice Pipeline failed to start! Error: {e}")
    ...
    if not workout_started:
        st.markdown(
            """
            <div style="border: 10px dashed #444; padding: 48px 32px; text-align: center; color: #888; margin-top: 32px;">
                <h2 style="color:#ccc; margin-bottom:8px;">👈 Set your workout plan</h2>
                <p>Choose your exercise, sets and reps in the sidebar, then click <strong>Start Workout</strong>.</p>
            </div>
            """,
